...
class EventDrivenRead():
    ...
    def CANReadThreadFunc(self):
        ...
        try:        
            ...
            stsResult = self.m_objPCANBasic.SetValue(self.PcanHandle, PCAN_RECEIVE_EVENT, self.m_ReceiveEvent)
            ...
            if stsResult != PCAN_ERROR_OK:
                ...
                ##
                self.m_objPCANBasic.SetValue(self.PcanHandle, PCAN_RECEIVE_EVENT, 0)
        except:
