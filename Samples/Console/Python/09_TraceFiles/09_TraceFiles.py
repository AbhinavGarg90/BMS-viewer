...
class TraceFiles():
    ...
    def __init__(self):
        ...
        print("Press any key to start tracing...")
        self.getch()
        if self.ConfigureTrace():
            if self.StartTrace():
                ...
                print("Press any key to stop trace and quit")
                self.getch()
                self.StopTrace()
    ...
    def GetFormattedError(self, error):
        ...
        stsReturn = self.objPCANBasic.GetErrorText(error,0x09)
